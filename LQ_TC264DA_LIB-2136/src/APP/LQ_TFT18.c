...
//#define TFTSPI_SCK      P20_10    // SPI SCK管脚
//#define TFTSPI_SDI      P20_11     // SPI MOSI管脚
//#define TFTSPI_DC       P20_13     // D/C管脚
//#define TFTSPI_RST      P20_12     // RESET管脚
...
void TFTSPI_CLS(unsigned short color)
{
  ...
  for(i=0;i<=TFT18W+5;i++)      //160
  {
    for(j=0;j<=TFT18H+5;j++)
    {
      TFTSPI_Write_Word(color);
    }
  }
...
{
  "北京龙邱丘智能科技淘宝店液晶单片机智能车器人启动中电压量不足请稍候，！：℃攻击娱乐模式普通格斗对话俯卧撑倒立握手敬礼跳舞蹈运动蓝精灵太极街舞温度—不响丸辣"
};
...
const unsigned char hanzi16x16[] = {
  ...
  0x04,0x20,0x04,0x20,0x0A,0x20,0x09,0x22,0x11,0x22,0x20,0x22,0x40,0x1E,0x80,0x00,/*"丸",2*/
  0x20,0x20,0x10,0x20,0x11,0xFC,0xFC,0x20,0x00,0x20,0x45,0xFC,0x29,0x24,0xFD,0x24,
  0x11,0xFC,0x10,0x20,0xFC,0x70,0x10,0xA8,0x21,0x24,0x22,0x22,0x40,0x20,0x80,0x20,/*"辣",3*/
};
...
/*!
  ...
  * @note     内部调用
  *
  * @see      TFTSPI_P8X8(1, 1, "123456", u16YELLOW, u16WHITE);
  *
  * @date     2019/6/13 星期四
  */
...
/*!
  ...
  * @note     无
  *
  * @see      TFTSPI_P6X8Str(1, 1, "123456", u16YELLOW, u16WHITE);
  *
  * @date     2019/6/13 星期四
  */
...
/*!
  ...
  * @note     无
  *
  * @see      TFTSPI_P8X8Str(1, 1, "123456", u16YELLOW, u16WHITE);
  *
  * @date     2019/6/13 星期四
  */
...
/*!
  ...
  * @note     无
  *
  * @see      TFTSPI_P8X16Str(1, 1, "123456", u16YELLOW, u16WHITE);
  *
  * @date     2019/6/13 星期四
  */
...
/*!
  ...
  *
  * @see      TFTSPI_P16x16Str(1, 1, "123456", u16YELLOW, u16WHITE);
  *
  * @date     2019/6/13 星期四
  */
...
{
    TFTSPI_Show_Pic2(110,18,20,10,gImage_Battery_S); //显示电池图标20*10像素
}
...
{
    TFTSPI_Show_Pic2(xs,ys,127,44,gImage_lo);       //80,gImage_ftflogo);     //
}
...
void TFTSPI_BinRoad(unsigned char wide_start, unsigned char high_start, unsigned char high, unsigned char wide, unsigned char *Pixle)
{
    ...
    {
            if(Pixle[i]==255)
            TFTSPI_Write_Word(u16WHITE);
            else
            TFTSPI_Write_Word(u16BLACK);
...
//
//}
//void TFTSPI_Image(unsigned char wide_start, unsigned char high_start, unsigned char high, unsigned char wide, unsigned char *Pixle)
//{
//    unsigned long i;
//    /* 设置显示范围 */
//    TFTSPI_Set_Pos(wide_start, high_start, wide_start - 1 + wide, high_start - 1 + high);
